"""
EXPERIMENT 3: EfficientNet-B0 + Cross-Entropy (Baseline)
=========================================================
Change from Exp1: ResNet18 → EfficientNet-B0 (5.3M params, compound scaling)
Everything else SAME as baseline.

Purpose: Does a more efficient architecture help?

Reference: Tan & Le (2019) "EfficientNet: Rethinking Model Scaling" ICML
"""
...
class Config:
    ...
    RESULTS_DIR = 'results/exp3_efficientnet'
    EXP_NAME = 'Exp3: EfficientNet-B0 + CE'
